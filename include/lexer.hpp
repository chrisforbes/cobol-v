...
enum class TokenType {
    ...
    FETCH, GATHER, COMPONENT, INTERPOLATE, CENTROID, SAMPLE, OFFSET,
    ...
    INQUIRE, SIZE, LOD, LEVELS, GRADIENTS, COMPARING, PROJECTION, BIAS,
    ...
    FLOAT, I, V,
    U, B, M, IV, UV, BV,
    FLOAT_TO_INT, FLOAT_TO_UINT, INT_TO_FLOAT, UINT_TO_FLOAT,
